...
import '../Timeline/timeline.css'; // Ensure the CSS file is linked properly
...
const Timeline = () => {
    return (
        <div className="timeline">
            ...
            {/* Brain Rain */}
            <div className="left-column date">September 2024</div>
            ...
            {/* CNN */}
            <div className="left-column date">June 2024</div>
...
{/* CNN */}
            ...
            {/* CNN */}
            <div className="left-column date">December 2021</div>
            ...
            {/* CNN */}
            <div className="left-column date">January 2021</div>
