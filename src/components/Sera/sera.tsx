        ...
        <div className="page-margins">
          ...
          <div className="background">
            <div id="resume-section" className="topic">
              ...
              <a className="right" href="https://i.imgur.com/wmGvrsH.png" target="_blank" download="SophiaDeLaRosa.pdf"><button className="button-56" role="button">download</button></a>
              </p>
