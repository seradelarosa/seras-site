          ...
          <div className="background">
            <div id="portfolio" className="topic">
              <div className="shrink">
                ...
                <h3 className="top-border">Dungeons & Devs v.2</h3>
                <div className="inline">
                ...
                <h3 className="top-border">Progressive Web Application Text Editor</h3>
                <div className="inline">
                ...
                <h3 className="top-border">NoSQL Social Networking App</h3>
                <div className="inline">
                ...
                <h3 className="top-border"> Dungeons & Devs v.1</h3>
                <div className="inline">
                ...
                <h3 className="top-border">Object-relational mapping (ORM) E-Commerce back-end</h3>
                <div className="inline">
                ...
                <h3 className="top-border">Express.js Note Taker</h3>
                <div className="inline">
                ...
                <h3 className="top-border">Object-Oriented Programming Team Profile Generator</h3>
                <div className="inline">
                ...
                <h3 className="top-border">Music Discovery App</h3>
                <div className="inline">
                ...
                <h3 className="top-border"> Day Planner using Third-Party APIs </h3>
                <div className="inline">
                ...
                <h3 className="top-border"> Web API Code Quiz </h3>
                <div className="inline">
                ...
                <h3 className="top-border"> JavaScript Password Generator </h3>
                <div className="inline">
